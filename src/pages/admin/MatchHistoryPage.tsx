...
export const MatchHistoryPage = () => {
  ...
  if (loading) {
    return <div className="p-8 text-center">{t('matchHistory.loading')}</div>;
  }
                    ...
                    <div className="mt-2 sm:flex sm:justify-between">
                      <div className="sm:flex">
                        <p className="flex items-center text-sm text-gray-500">
                          {t('matchHistory.whitePlayers', { count: match.teamWhite.length })} |{' '}
                          {t('matchHistory.redPlayers', { count: match.teamRed.length })}
                        </p>
                      </div>
                    </div>
                  </div>
