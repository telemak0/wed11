...
export const ScoreModal: React.FC<ScoreModalProps> = ({ isOpen, onClose, onSave, initialWhite = 0, initialRed = 0 }) => {
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex justify-between items-center mb-6 gap-4">
                <div className="text-center flex-1">
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('scoreModal.whiteTeamLabel')}</label>
                    <input 
                        type="number" 
                        min="0"
                        value={white}
                ...
                <div className="text-center flex-1">
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('scoreModal.redTeamLabel')}</label>
                    <input 
                        type="number" 
                        min="0"
                        value={red}
